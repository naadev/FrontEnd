const endpoint_tags_bor = 'http://127.0.0.1:5000/resdec/list_items/?var_environment_id=1&relationship_type_id=2&item=';
const endpoint_algorithms_bor = 'http://127.0.0.1:5000/resdec/list_algorithms/?relationship_type_id=2';
...
async function loadRecomendations(algorithm_id, number_recommendations, item_evaluated) {
    ...
    var url_endpoint = `http://127.0.0.1:5000/resdec/transition_components_based_ratings/?relationship_type_id=2&var_environment_id=1&algorithm_id=${algorithm_id}&username=${userLogon}&number_recommendations=${number_recommendations}&item_evaluated=${item_evaluated}`;
...
function loadLastView() {
    ...
    if (userLogon.length > 0) {
        document.getElementById("list_items_last_bor").innerHTML = "";
        var url_last_view = `http://127.0.0.1:5000/resdec/list_last_items_used/?username=${userLogon}&var_environment_id=1&number_items=10`;
